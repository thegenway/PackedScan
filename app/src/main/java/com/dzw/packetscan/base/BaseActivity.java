...
package com.dzw.packetscan.base;
...
public class BaseActivity<Binding extends ViewBinding> extends XPageActivity {
    ...
    public <T extends XPageFragment> T openNewPage(Class<T> clazz, boolean addToBackStack) {
        CoreSwitchBean page = new CoreSwitchBean(clazz)
                .setNewActivity(true).setAddToBackStack(addToBackStack);
        return (T) openPage(page);
    }
